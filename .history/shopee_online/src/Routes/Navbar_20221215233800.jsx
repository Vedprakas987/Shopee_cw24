      ...
      <Box bg={useColorModeValue('green', 'green')} px={3} padding="5px">
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <HStack spacing={8} alignItems={'center'}>
            <Box>
              <img   style={{borderRadius:"60%",width:"30%",marginLeft:"10%"}} src="https://i.imgur.com/Ea4kEa7.png"/>
            </Box>
            <VStack  padding="0p 2rem">
                <HStack w="100%">
                <Input borderRadius="20px" marginLeft="-45%" bg="white" color="black"></Input>
          ...
          <Flex alignItems={'center'}>
            <Text cursor="pointer" marginRight={10}>Cart</Text>
            <Menu>
              <MenuButton
                as={Button}
                rounded={'full'}
