...
const Dashboard = () => {
    ...
    return (
        ...
        <div>
            ...
            <Bestselling products={data.electronics} height={"70vh"} v1={4} v2={2} v3={2} v4={2}/>
            <Carousel padding="20px" mt="20px" cards={card2}/>
            <Center mb={"20px"} mt={"20px"}>
           ...
           <Bestselling products={data.Recom} height={"65vh"}  v1={6} v2={5} v3={5} v4={2} v5={1}/>
